"""
Takes a Mesh and MeshValueCollection (created by e.g. ase_mesh_metric_mmg.py) and
...
meshname =  os.path.join(output_path, 'ase_variable_ocean')
meshfile = os.path.join(MAIN_PATH, config['output_files']['meshfile'])
mvc_file = os.path.join(MAIN_PATH, config['output_files']['mvc_file'])
