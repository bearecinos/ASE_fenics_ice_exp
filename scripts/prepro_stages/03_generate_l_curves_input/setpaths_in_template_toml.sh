...
toml set --toml-path ase_template.toml io.input_dir "$input_run_inv"
toml set --toml-path ase_template_cov.toml io.input_dir "$input_run_inv"

toml set --toml-path ase_template.toml io.output_dir "$run_lcurves_output_dir/output"
toml set --toml-path ase_template_cov.toml io.output_dir "$run_lcurves_cov_output_dir/output"

toml set --toml-path ase_template.toml io.diagnostics_dir "$run_lcurves_output_dir/diagnostics"
toml set --toml-path ase_template_cov.toml io.diagnostics_dir "$run_lcurves_cov_output_dir/diagnostics"
