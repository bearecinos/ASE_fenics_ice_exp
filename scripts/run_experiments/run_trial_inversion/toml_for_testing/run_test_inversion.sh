...
export run_inv_output_dir=$OUTPUT_DIR/03_inversion_test
...
path_logs=$RUN_CONFIG_DIR/run_trial_inversion/tomls_for_testing
...
mpirun -n $1 python $FENICS_ICE_BASE_DIR/runs/run_inv.py $2 |& tee $path_logs/log_test.txt
OUT=$(tail "$path_logs/log_test.txt")
