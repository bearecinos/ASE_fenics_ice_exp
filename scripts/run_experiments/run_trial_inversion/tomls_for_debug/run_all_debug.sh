...
export run_inv_output_dir=$OUTPUT_DIR/04_debug_inversion
...
mpirun -n $1 python $FENICS_ICE_BASE_DIR/runs/run_inv.py $2 |& tee $path_logs/log_tom1_inv.txt
OUT=$(tail "$path_logs/log_tom1_inv.txt")
