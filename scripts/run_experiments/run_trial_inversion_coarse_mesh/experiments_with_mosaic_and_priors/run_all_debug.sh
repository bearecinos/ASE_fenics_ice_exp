...
export run_inv_output_dir=$OUTPUT_DIR/10_coarse_mesh_mosaic_priors
...
path_logs=$RUN_CONFIG_DIR/run_trial_inversion_coarse_mesh/experiments_with_mosaic_and_priors
