...
export run_inv_output_dir=$OUTPUT_DIR/09_coarse_mesh_subsample_mosaic
...
path_logs=$RUN_CONFIG_DIR/run_trial_inversion_coarse_mesh/experiments_with_mosaic_subsampling
...
#echo $OUT | mail -s "run inv sigma finish config1" beatriz.recinos@ed.ac.uk
